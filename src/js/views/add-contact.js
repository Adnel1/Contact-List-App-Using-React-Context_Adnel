	...
	return (
		<div className="d-flex align-items-center flex-column">
			<div className="col-md-6">
				<h1 className="text-center text-secondary mb-4">Add a new contact</h1>
				<form className="mb-3">
					...
					<button onClick={() => actions.pushSomeData(inputName, inputEmail, inputAddress, inputPhone)} type="submit" className="btn btn-success col-12">Add +</button>
				</form>
				<Link to="/">
